...
import { ArrowLeft, UserPlus, User, Mail, Lock, Briefcase, Clock } from 'lucide-react-native';
    ...
    const handleSave = async () => {
        ...
        try {
            await createCandidate({
                ...
                ExperienceYears: parseInt(years) || 0,
            });
            Alert.alert('Thành công', 'Đã thêm ứng viên mới vào hệ thống!');
            router.back();
        } catch (e) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.body} contentContainerStyle={{ paddingBottom: 100 }}>
                ...
                <Text style={styles.subtitle}>Điền thông tin ứng viên mới vào hệ thống quản trị.</Text>
            ...
            <View style={styles.footer}>
                <TouchableOpacity style={styles.submitBtn} onPress={handleSave} disabled={loading} activeOpacity={0.85}>
                    ...
                    <Text style={styles.submitBtnText}>{loading ? 'ĐANG LƯU...' : 'LƯU HỒ SƠ ỨNG VIÊN'}</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    );
